...
6. In the function dropdown at the top, pick **`setupSheets`** → **Run**.
7. Google asks for authorization. You'll hit a scary screen:
   **Advanced** → **Go to <project name> (unsafe)** → **Allow**.
   This is normal for a script you wrote yourself and haven't published.
8. Switch back to the Sheet. You should now have four tabs:
...
<details>
<summary>Why a key in the URL instead of a signature check</summary>
